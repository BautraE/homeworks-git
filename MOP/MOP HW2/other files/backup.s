    ldr r8, [r2, platums1*augstums1*4] @ vertiba no matrix1
    ldr r9, [r5, platums2*augstums2*4] @ vertiba no matrix2
...
matmul:
    ...
    mul r3, r3, r3 lsl #2 @ gala adrese m3 
    ...
    @ mul r10, r0, r1 lsl #2 @ adreses nobide m2
    @ mul r11, #0 @ platums * augstums
    ///////////////////////////////////// 
    mul r10, r1, r4, lsl #2 @ adreses nobīde m2
    rsb r10, r10, #0 @ m2 adreses nobīdes pārvēršana uz negatīvo
    @ #-4 adreses nobīde m1
    mla r2, r0, r1, r2 @ sakotneja adrese tiek pabidita m1
    mla r5, r3, r4, r5 @ sakotneja adrese tiek pabidita m2
